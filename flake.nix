{
  ...
  let
    ...
    # Overlay to guarantee annotated-types exists before pyproject-build-systems overlays run.
    annotatedTypesOverlay = final: prev: {
      "annotated-types" =
        let
          base = prev."annotated-types" or pkgs.python3Packages."annotated-types";
        in
          base.overrideAttrs (old: {
            passthru = (old.passthru or {}) // { format = (old.passthru or {}).format or "pyproject"; };
          });
    };
